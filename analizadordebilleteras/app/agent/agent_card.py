...
def build_agent_card() -> AgentCard:
    ...
    return AgentCard(
        name=name,
        description=(
            f"ERC-8183 seller agent ({name}) — analiza una direccion BNB Chain y "
            "entrega un resumen en espanol de sus saldos y actividad reciente. "
            "negotiate + notify_funded over A2A."
        ),
